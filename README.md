...
For the usage of the second argument please refer to the [Stitches docs](https://stitches.dev/docs/framework-agnostic#styling)
...
So css generated by style props will be hard to override (it's technically possible using the `css` prop).
...
This is just normal Stitches code with no extra layer, you can find the documentation [here](https://stitches.dev/docs/framework-agnostic)

For convinience Hope UI re-export it configured with it's default theme.
