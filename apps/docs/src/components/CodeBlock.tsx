  ...
  return (
    <div class="group relative">
      <button
        ...
        class="absolute end-2 top-2 z-10 rounded-md border border-strong bg-surface-raised-hovered/80 px-2 py-1 text-xs font-medium text-foreground-muted opacity-0 backdrop-blur transition-opacity hover:bg-surface-raised-pressed focus-visible:opacity-100 group-hover:opacity-100"
      >
        {copied() ? "Copied" : "Copy"}
      </button>
