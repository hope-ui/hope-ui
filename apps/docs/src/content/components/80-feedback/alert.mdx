...
`Alert` is a **compound** component — a namespace object whose parts you compose:
`Alert.Root`, `Alert.Icon`, `Alert.Content`, `Alert.Title`, `Alert.Description`, `Alert.Actions`,
and `Alert.CloseTrigger`.
...
<Alert.Root colorScheme="info" title="Convenience" description="…" />
```
