...
<Preview>
  <div class="flex flex-wrap items-center gap-3 rounded-lg bg-surface-inverse p-6">
    <Button variant="inverted" colorScheme="primary">Primary</Button>
    <Button variant="inverted" colorScheme="neutral">Neutral</Button>
    <Button variant="inverted" colorScheme="success">Success</Button>
    <Button variant="inverted" colorScheme="danger">Danger</Button>
  </div>
</Preview>
...
<Preview>
  ...
  <Button variant="soft" colorScheme="neutral" loading loadingText="Uploading…">Upload</Button>
  <Button variant="outline" colorScheme="danger" loading loaderPlacement="end">Delete</Button>
</Preview>
...
<div class="not-prose my-6 flex gap-3 rounded-xl bg-primary-soft p-4 text-sm leading-relaxed text-primary-emphasis">
  ...
  <div>
    When you render anything other than a native <code>button</code>, set <code>nativeButton</code>
    to <code>false</code>. Button then applies <code>role="button"</code>, manages the tab order,
    and synthesizes keyboard activation (Space and Enter) — the behavior a real button has for
    free. The <code>as unknown as</code> cast on the spread is only needed to satisfy TypeScript
    when switching to a different element type; the runtime behavior is unaffected.
  </div>
</div>
...
<PropsTable
  ...
  rows={[
    { slot: "root", attr: "button", description: "The rendered element (a native button by default)." },
    { slot: "label", attr: "button-label", description: "Wraps the children — or the loadingText while loading." },
    { slot: "startDecorator", attr: "button-start-decorator", description: "Leading decorator wrapper. Rendered only when startDecorator is set." },
    { slot: "endDecorator", attr: "button-end-decorator", description: "Trailing decorator wrapper. Rendered only when endDecorator is set." },
    { slot: "loader", attr: "button-loader", description: "Loader wrapper. Rendered only while loading; marked aria-hidden." },
  ]}
/>
...
<Preview>
  <Button variant="solid" slotClasses={{ root: "rounded-full px-6" }}>Pill</Button>
  <Button variant="soft" colorScheme="success" slotClasses={{ label: "uppercase tracking-wide" }}>
    deploy!
  </Button>
</Preview>
...
<Preview>
  ...
  >
    <Button variant="solid" colorScheme="primary">Branded</Button>
    <Button variant="soft" colorScheme="neutral">Branded</Button>
  </ThemeProvider>
</Preview>
  ...
  rows={[
    {
      ...
      type: "ButtonVariant",
      default: '"default"',
      description: "Visual style: default, solid, inverted, soft, outline, ghost, link. default is neutral chrome and ignores colorScheme; inverted is the swap of solid for solid surfaces.",
    },
    {
      prop: "colorScheme",
      type: "ButtonColorScheme",
      default: '"primary"',
      description: "Semantic role color: primary, neutral, success, info, warning, danger. Applied by the colored variants; ignored by default.",
    },
    {
      prop: "size",
      type: "ButtonSize",
    ...
    },
    {
      ...
      type: "boolean",
      default: "false",
      description: "Shows a loader and sets aria-busy. Blocks activation but keeps the button in the tab order — it does not use the disabled attribute.",
    },
    {
      prop: "loadingText",
      type: "JSX.Element | (() => JSX.Element)",
      default: "",
      description: "Replaces the label while loading, kept visible by an inline start loader. A factory is reuse-safe as an app-wide default.",
    },
    {
      prop: "loader",
      type: "JSX.Element | (() => JSX.Element)",
      default: "",
      description: "Custom loader content. Defaults to hope's spinner. A factory is reuse-safe as an app-wide default.",
    },
    {
      prop: "loaderPlacement",
      type: '"center" | "start" | "end"',
      default: '"center"',
      description: "Where the loader sits while loading. center overlays it and hides the label, preserving width.",
    },
    {
      prop: "startDecorator",
      type: "JSX.Element",
    ...
    },
    {
      ...
      type: "boolean",
      default: "false",
      description: "Renders a square, icon-only button (icon passed as children, sized and centered per size). Needs an aria-label for an accessible name. Not for use with fullWidth or the link variant.",
    },
    {
      prop: "disabled",
      type: "boolean",
      default: "false",
      description: "Disables the button. Native buttons use the disabled attribute; a non-native element uses aria-disabled and blocked handlers. Keeps its variant color, dimmed.",
    },
    {
      prop: "nativeButton",
      type: "boolean",
      default: "true",
      description: "Whether the rendered element is a real button. Set false when rendering another element so Button supplies role, tabIndex, and keyboard activation.",
    },
    {
      prop: "render",
      type: "(props) => JSX.Element",
      default: "",
      description: "Render Button as another element or component. Receives Button's computed props. The only polymorphism mechanism — there is no as prop.",
    },
    {
      prop: "class",
      type: "string",
      default: "",
      description: "Extra classes merged onto the root slot; your utilities win conflicts via tailwind-merge.",
    },
    {
      prop: "slotClasses",
      type: 'SlotClasses<"button">',
      default: "",
      description: "Per-slot class overrides, keyed by root, label, startDecorator, endDecorator, loader.",
    },
    {
      prop: "type",
...
<PropsTable
  ...
  rows={[
    { key: "Enter", action: "Activates the button (native and rendered-as elements)." },
    { key: "Space", action: "Activates the button (synthesized for rendered-as elements; page scroll is prevented)." },
    { key: "Tab", action: "Moves focus. A disabled native button is skipped; a loading button keeps its place." },
  ]}
/>
