...
We can go a step further and add dark mode support to our `Card` component. Hope UI provides a `_dark` style prop that lets you define the style to apply when the application is in dark mode.
