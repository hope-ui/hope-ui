...
The `createGlobalStyles` function return another function, which you must call in your app.
...
`createGlobalStyles` can accept a _function_ as parameter which give you access to the current theme.
