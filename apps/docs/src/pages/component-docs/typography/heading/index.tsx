import { Alert, AlertDescription, Anchor, Heading, Text, VStack } from "@hope-ui/solid";
  ...
  return (
    <PageLayout previousLink={previousLink} nextLink={nextLink} contextualNavLinks={contextualNavLinks}>
      ...
      <Text mb="$5">
        ...
        so you can use all the style props and add responsive styles as well. It renders a semibold <Code>h2</Code> tag
        by default.
      </Text>
      ...
      <Text mb="$5">
        To change the rendered <Code>h</Code> tag pass the <Code>level</Code> prop with a value from 1 to 6. For
        example, level 3 will render an <Code>h3</Code>. Use <strong>Inspect Element</strong> to see the element that
        gets rendered in html.
      </Text>
      ...
      <Alert status="warning" mb="$12">
        <AlertDescription>
          The <Code>level</Code> prop is primarily for semantic purpose as it does not alter the heading styles
        </AlertDescription>
      </Alert>
      ...
      <Text mb="$5">
        <Code>Heading</Code> base styles and default props can be overridden in the Hope UI theme configuration like
        below:
      </Text>
