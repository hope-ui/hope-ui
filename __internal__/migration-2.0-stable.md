...
rationale: `__internal__/plan.md`, "Distribution model".
...
alias removed, three projects that each mean one thing. See `__internal__/testing.md`.
...
hydration-fixture bridge (`virtual:hydration-fixture?id=<subject>`). See `__internal__/testing.md`.
