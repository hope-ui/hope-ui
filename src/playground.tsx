  ...
  return (
    <Box p="$4">
      <VStack alignItems="start" spacing="$4">
        ...
        <Tooltip label="HI MOM !" withArrow arrowSize={10} opened={isOpen()} placement="top">
          <Button>Hover me</Button>
        </Tooltip>
        <Tooltip label="HI MOM !" withArrow arrowSize={20} placement="top">
          <Button>Hover me 2</Button>
        </Tooltip>
        <Text>
          Lorem ipsum dolor sit, amet consectetur adipisicing{" "}
          <Tooltip label="the elit" inline placement="top" withArrow>
            <strong>elit</strong>
          </Tooltip>
