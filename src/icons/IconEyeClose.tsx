...
export function IconEyeClose(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <g fill="none">
        ...
        />
        <path
          d="M12.454 16.697L9.75 13.992a4 4 0 0 1-3.742-3.741L2.335 6.578A9.98 9.98 0 0 0 .458 10c1.274 4.057 5.065 7 9.542 7c.847 0 1.669-.105 2.454-.303z"
          fill="currentColor"
        />
      </g>
    </svg>
