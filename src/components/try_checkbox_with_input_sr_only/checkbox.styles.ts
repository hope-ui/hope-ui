...
export const checkboxInputStyles = css(srOnlyStyles);
...
export const checkboxControlStyles = css({
  ...
  [`.${checkboxInputStyles}:disabled + &`]: {
    opacity: 0.4,
    cursor: "not-allowed",
  },

  [`.${checkboxInputStyles}[aria-invalid=true] + &`]: {
    borderColor: "$danger8",
    color: "$danger9",
  },

  [`.${checkboxInputStyles}[aria-invalid=true]:focus + &`]: {
    boxShadow: "0 0 0 3px $colors$danger5",
    borderColor: "$danger8",
  },

  [`.${checkboxInputStyles}:checked + &,
    .${checkboxInputStyles}:checked:hover + &,
    .${checkboxInputStyles}:checked:focus + &,
    .${checkboxInputStyles}[aria-invalid=true]:checked + &,
    .${checkboxInputStyles}[aria-invalid=true]:checked:hover + &,
    .${checkboxInputStyles}[aria-invalid=true]:checked:focus + &,
    .${checkboxInputStyles}:indeterminate + &,
    .${checkboxInputStyles}:indeterminate:hover + &,
    .${checkboxInputStyles}:indeterminate:focus + &,
    .${checkboxInputStyles}[aria-invalid=true]:indeterminate + &,
    .${checkboxInputStyles}[aria-invalid=true]:indeterminate:hover + &,
    .${checkboxInputStyles}[aria-invalid=true]:indeterminate:focus + &`]: {
  ...
  variants: {
    variant: {
      outline: {
        ...
        [`.${checkboxContainerStyles}:hover &`]: {
          borderColor: "$neutral8",
        },

        [`.${checkboxInputStyles}[aria-invalid=true] + &:hover`]: {
          borderColor: "$danger8",
        },
      },
      filled: {
        ...
        [`.${checkboxContainerStyles}:hover &, .${checkboxInputStyles}:focus + &`]: {
