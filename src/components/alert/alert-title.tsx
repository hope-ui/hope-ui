...
export type AlertTitle<C extends ElementType> = HopeComponentProps<C, AlertTitleVariants>;

const hopeAlertTitleClass = "hope-alert-title";

export function AlertTitle<C extends ElementType = "div">(props: AlertTitle<C>) {
