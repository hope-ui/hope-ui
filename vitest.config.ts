...
// `@solid-zero/components` depends on `@solid-zero/primitives` as a real workspace package,
  ...
  test: {
    ...
    projects: [
      ...
      },
      {
        ...
        resolve: { alias: [...solidZeroAlias, ...serverBuildAlias] },
        test: {
          name: "ssr",
          environment: "node",
