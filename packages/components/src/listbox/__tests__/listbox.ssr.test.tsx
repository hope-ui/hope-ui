...
describe("Listbox SSR", () => {
  ...
  it("matches its server output byte for byte", async () => {
    ...
    expect(html).toMatchInlineSnapshot(
      `"<div _hk=0060010 aria-label="Choose a fruit" id="000" role="listbox" aria-orientation="vertical" tabindex="-1" class="text-foreground overflow-y-auto outline-none min-w-36" data-slot="listbox" dir="ltr" ><div _hk=0060011010 role="group" class="not-last:pb-1" data-slot="listbox-group"><div _hk=00600110140 id="0060011011" class="px-1.5 py-1 text-xs text-foreground-muted" data-slot="listbox-group-label">Citrus</div><div _hk=0060011017010 id="0060011015" role="option" aria-selected="false" tabindex="0" class="relative flex cursor-default items-center rounded-md pe-8 outline-none select-none data-active:bg-active data-active:text-on-active data-disabled:pointer-events-none data-disabled:opacity-disabled [&amp;_svg]:size-4 gap-1.5 py-1 ps-1.5 text-sm" data-slot="listbox-item" >Orange</div><div _hk=006001101a010 id="0060011018" role="option" aria-selected="false" tabindex="0" class="relative flex cursor-default items-center rounded-md pe-8 outline-none select-none data-active:bg-active data-active:text-on-active data-disabled:pointer-events-none data-disabled:opacity-disabled [&amp;_svg]:size-4 gap-1.5 py-1 ps-1.5 text-sm" data-slot="listbox-item" >Lemon</div></div><div _hk=00600130 role="presentation" aria-hidden="true" class="my-1 h-px bg-subtle pointer-events-none" data-slot="listbox-separator"></div><div _hk=0060014010 role="group" class="not-last:pb-1" data-slot="listbox-group"><div _hk=00600140140 id="0060014011" class="px-1.5 py-1 text-xs text-foreground-muted" data-slot="listbox-group-label">Berries</div><div _hk=0060014017010 id="0060014015" role="option" aria-selected="true" data-selected tabindex="0" class="relative flex cursor-default items-center rounded-md pe-8 outline-none select-none data-active:bg-active data-active:text-on-active data-disabled:pointer-events-none data-disabled:opacity-disabled [&amp;_svg]:size-4 gap-1.5 py-1 ps-1.5 text-sm" data-slot="listbox-item" ><span _hk=00600140170130 class="absolute end-2 flex items-center justify-center [&amp;_svg]:size-4" data-slot="listbox-item-indicator" aria-hidden="true"><svg _hk=006001401701310 viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 6 9 17l-5-5"></path></svg></span>Strawberry</div><div _hk=006001401a010 id="0060014018" role="option" aria-selected="false" tabindex="0" class="relative flex cursor-default items-center rounded-md pe-8 outline-none select-none data-active:bg-active data-active:text-on-active data-disabled:pointer-events-none data-disabled:opacity-disabled [&amp;_svg]:size-4 gap-1.5 py-1 ps-1.5 text-sm" data-slot="listbox-item" >Blueberry</div></div></div><input _hk=00603000 type="hidden" name="fruit" value="3">"`,
    );
  });
});
