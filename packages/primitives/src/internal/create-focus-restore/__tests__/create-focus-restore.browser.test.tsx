...
import { createFocusTrap } from "../../create-focus-trap/create-focus-trap";
import { createFocusRestore } from "../create-focus-restore";
...
function TestHarness(props: { active: Accessor<boolean>; trap?: boolean }) {
  ...
  if (props.trap) {
    createFocusTrap({ active: props.active, ref: containerRef });
  }
