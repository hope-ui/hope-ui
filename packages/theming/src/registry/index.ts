...
// `ThemeablePropsRegistry` (per-component behavioral/chrome default vocabulary). A top-level `src/`
// folder (the contract seam, sibling to `recipes`/`presets`/`theme-context`), re-exported by the root
