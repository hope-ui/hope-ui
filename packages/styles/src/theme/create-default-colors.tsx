...
import { createPalette, createReversePalette, reverseScale } from "./create-palette";

const whiteAlphaScale: PaletteScale = {
...
const blackAlphaScale: PaletteScale = {
  50: "rgba(0, 0, 0, 0.04)",
  100: "rgba(0, 0, 0, 0.06)",
  200: "rgba(0, 0, 0, 0.08)",
  300: "rgba(0, 0, 0, 0.16)",
...
const primaryScale: PaletteScale = {
  50: "#e6f6ff",
  100: "#bae3ff",
  200: "#7cc4fa",
  300: "#47a3f3",
...
const neutralScale: PaletteScale = {
  50: "#f9fafa",
  100: "#f4f5f6",
  200: "#e3e5e8",
  300: "#cfd3d8",
...
const dangerScale: PaletteScale = {
  50: "#ffe3e3",
  100: "#ffbdbd",
  200: "#ff9b9b",
  300: "#f86a6a",
...
export function createDefaultColors(cssVarPrefix: string): ThemeColors {
  ...
  return {
    light: {
      ...
      primary: createPalette(primaryScale),
      neutral: createPalette(neutralScale),
      success: createPalette(successScale),
      info: createPalette(infoScale),
      warning: createPalette(warningScale),
      danger: createPalette(dangerScale),
      common: {
        white: "#ffffff",
    ...
    dark: {
      /*
      whiteAlpha: reverseScale(whiteAlphaScale),
      blackAlpha: reverseScale(blackAlphaScale),
      primary: createReversePalette(primaryScale),
      neutral: createReversePalette(neutralScale),
      success: createReversePalette(successScale),
      info: createReversePalette(infoScale),
      warning: createReversePalette(warningScale),
      danger: createReversePalette(dangerScale),
      */
      common: {
